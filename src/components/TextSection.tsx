        ...
        <div className="space-y-8">
          <div>
            ...
            <Table>
              ...
              <TableHeader>
                <TableRow>
                  <TableHead className="w-44">Tamanho</TableHead>
                  <TableHead>Exemplo</TableHead>
                  <TableHead className="w-[35%]">Uso recomendado</TableHead>
                </TableRow>
              </TableHeader>
              <TableBody>
                <TableRow>
          ...
          <div className="pt-2">
            ...
            <Table>
              ...
              <TableBody>
                <TableRow>
                  <TableHead>Princípios</TableHead>
                  <TableCell>
                ...
                <TableRow>
                  <TableHead>Benefício Geral</TableHead>
                ...
                <TableRow>
                  <TableHead>SEO e Engajamento</TableHead>
                  <TableCell className="text-slate-700 dark:text-slate-300">
